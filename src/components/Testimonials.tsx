      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-background rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-elegant hover:shadow-copper transition-all duration-300 relative"
            >
              <Quote className="w-8 sm:w-10 h-8 sm:h-10 text-primary/20 absolute top-4 sm:top-6 right-4 sm:right-6" />
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-10 sm:w-12 h-10 sm:h-12 bg-gradient-copper rounded-full flex items-center justify-center">
                  <Star className="w-4 sm:w-5 h-4 sm:h-5 text-primary-foreground fill-primary-foreground" />
                </div>
        ...
        {/* Google-style Review */}
        <div className="bg-background rounded-xl sm:rounded-2xl md:rounded-3xl p-5 sm:p-6 md:p-8 lg:p-10 shadow-elegant max-w-lg mx-auto">
          <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            ...
            <span className="font-body text-xs sm:text-sm text-muted-foreground">Avaliação do Google</span>
          </div>
          ...
          <div className="flex gap-1 mb-3 sm:mb-4">
            {[...Array(5)].map((_, i) => (
              <Star
                key={i}
                className="w-4 sm:w-5 h-4 sm:h-5 text-[#FBBC05] fill-[#FBBC05]"
              />
            ))}
          </div>
